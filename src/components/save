                ...
                <v-dialog v-model="dialog" persistent max-width="600px">
                  <template v-slot:activator="{ on }">
                    <v-btn dark v-on="on" tile color="white" text>
                      ...
                      <p class="my-2 black--text">Folder</p>
                    </v-btn>
                  </template>
                  <v-card>
                    <v-card-title>
                      <span class="headline">Upload folder</span>
                    </v-card-title>
                    <v-card-text>
                      <v-container>
                        <v-row>
                ...
                <v-dialog v-model="dialog2" persistent max-width="600px">
                  ...
                  <v-card>
                    ...
                    <v-card-actions>
                      ...
                      <v-btn class="green--text" text @click="dialog2 = false">
                        <v-icon>mdi-cloud-upload</v-icon>Save
                      </v-btn>
                    </v-card-actions>
                  </v-card>
                ...
                <v-dialog v-model="dialog3" persistent max-width="600px">
                  ...
                  <v-card>
                    ...
                    <v-card-actions>
                      ...
                      <v-btn class="green--text" text @click="dialog3 = false">
                        <v-icon>mdi-cloud-upload</v-icon>Save
                      </v-btn>
                    </v-card-actions>
                  </v-card>
